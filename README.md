...
<img width="400" height="250" alt="image" src="https://github.com/user-attachments/assets/0ff8535c-82bc-4c42-9243-74d3edf996c2" />
...
For instruction to run the codes, you can check the individual ReadMe files for each folder. The dataset used in this project can be downlaoded from these links:
Put in /storage directory : https://www.kaggle.com/datasets/5ed40f3afdb35d0558adbad4b6a78dddf0e972bbd9b2d6fba1a0caafc4a67ea8
Put in the same dir as the train / test codes : https://www.kaggle.com/datasets/34eef62ee57d54eea9b8442341077ab565bb007414ef0e6addd1339a1cb02633 

These 2 datasets are used to train and test the Geodesic Regression and Shape Matching SMAL module on the SMAL datasets. We plan to release Objaverse dataset and codes soon.
