...
def train(args):
    ...
    pca_path = "PCA_PointCloudUDF_dense_rot_center_cleannoise_all_shapematch_0_16fil.npy"#"Xpca_voxels_dense_rot_center_cleannoise_all_shapematch_0_25fil_norm.npy"
    scalefactor_path = "ScaleFromRandomMesh_UDFPointCloud.npz.npy" #scale factor to 1.7 area bounding box point cloud size
    #scalefactorfromunitmesh_path = "ScaleFromUnitAreaMesh_UDFPointCloud.npz.npy"
    meshvertices = "SMALVertices_UDFFromPointCloud.npz"#"MeshVerticesSMALProcessed.npz"
